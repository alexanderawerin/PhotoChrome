...
- [x] Продвинутые настройки с ползунками (TuningPanel)
- [x] Больше базовых симуляций (Astia, Eterna, Acros, Pro 400H — всего 10)
- [x] WebGL-ускорение для обработки фото и видео
- [x] Dynamic Range (DR100/DR200/DR400)
- [x] White Balance пресеты (Daylight, Shade, Tungsten...)
- [x] Draggable crop — перетаскивание рамки обрезки
- [x] Web Worker для экспорта в фоновом потоке
- [x] EXIF метаданные в экспортируемых файлах
